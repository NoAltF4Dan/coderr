...
from .permissions import IsAuthenticatedCustomer, IsAuthenticatedBusiness, IsReviewOwner
...
class BaseInfoView(APIView):
    ...
    def get(self, request):
        ...
        business_profile_count = User.objects.filter(user__user_type='business').count()
